(function(module_name, factory){ /* jshint browser: true, node: true *//* global define:false */
	'use strict';
	...
	_public.isTopic= isTopic;
	 function isTopic(candidate){ return Object.getPrototypeOf(candidate) === Topic; }
